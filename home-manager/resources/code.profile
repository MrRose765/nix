...
whitelist ${HOME}/src/odoo
whitelist ${HOME}/src/industry
whitelist ${HOME}/src/enterprise
whitelist ${HOME}/src/upgrade
whitelist ${HOME}/src/upgrade-util
...
whitelist-ro ${HOME}/.oh-my-zsh/custom/aliases.zsh
