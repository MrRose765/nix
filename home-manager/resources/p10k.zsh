# Generated by Powerlevel10k configuration wizard on 2026-02-17 at 19:52 CET.
...
# left frame, sparse, few icons, concise, transient_prompt, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    current_db             # current database (e.g., mysql/postgres client)
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  function prompt_current_db() {
    # Only show if CURRENT_DB is actually set
    if [[ -n "$CURRENT_DB" ]]; then
        p10k segment -f 111 -i '🐘' -t "$CURRENT_DB"
    fi
  }
